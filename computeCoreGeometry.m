...
function [thisP, thisW] = computeCoreGeometry(thisC, thisP, thisW, Time)
    ...
    if thisP.N_wp > 1
        Np = thisW.primary(1).N;

        if isequal(thisC.f_0, 0)
            vwf = thisW.primary(1).waveform.v_p/Np;
            ...
            vwf = thisW.primary(1).waveform.v_pHF/Np;
            ...
            vwf = thisW.primary(1).waveform.v_pLF/Np;
        ...
        if isequal(thisC.f_0, 0)
            vwf = thisW.primary.waveform.v_p/Np;
            ...
            vwf = thisW.primary.waveform.v_pHF/Np;
            ...
            vwf = thisW.primary.waveform.v_pLF/Np;
